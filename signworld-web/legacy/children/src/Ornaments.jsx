...
// recolored bright and playful for the Children app.

export function SaduField({ opacity = 0.1, color = '#f0a83c' }) {
  return (
...
export function PalmMark({ className = '', stroke = '#e8930f' }) {
  return (
...
export function Divider({ color = '#ef5f4c' }) {
  return (
    <svg viewBox="0 0 200 16" className="divider" aria-hidden="true" fill="none">
      <g stroke={color} strokeWidth="1.4" opacity="0.6">
