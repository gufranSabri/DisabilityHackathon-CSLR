...
export function SaduField({ opacity = 0.05, color = '#e8b23f' }) {
  return (
...
export function PalmMark({ className = '', stroke = '#c88a3e' }) {
  return (
...
export function Divider({ color = '#e8b23f' }) {
  return (
...
// Slow chalk-dust drift used behind the home/role-picker screen.
export function ChalkDust({ count = 16 }) {
  return (
